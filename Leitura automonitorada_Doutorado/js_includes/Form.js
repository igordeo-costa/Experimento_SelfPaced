...
jqueryWidget: {
    _init: function () {
        ...
        this.continueMessage = dget(this.options, "continueMessage", "Clique para continuar");
        ...
        this.obligatoryErrorGenerator =
            dget(this.options, "obligatoryErrorGenerator",
                 function (field) { return "O campo \u2018" + field + "\u2019 é obrigatório."; });
        this.obligatoryCheckboxErrorGenerator =
            dget(this.options, "obligatoryCheckboxErrorGenerator",
                 function (field) { return "Você deve selecionar o campo " + field + " para continuar."; });
        this.obligatoryRadioErrorGenerator =
            dget(this.options, "obligatoryRadioErrorGenerator",
                 function (field) { return "Você deve selecionar uma opção para \u2018" + field + "\u2019."; });
